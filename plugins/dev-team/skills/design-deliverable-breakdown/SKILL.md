...
- It provides value entirely on its own, without depending on a sibling deliverable shipping first.
...
### 3 — Check for existing deliverables to reuse

Before creating new feature-work-items, ask the user whether any of the drafted deliverables
correspond to feature-work-items that already exist. This design may be reorganizing prior
planning, or priorities may have shifted since related work was already tracked. Use
`AskUserQuestion` to ask, per deliverable (or in batches of up to 4): "Does this deliverable
correspond to an existing feature-work-item?" with options "Yes — I'll provide the key",
"No — create a new one".
